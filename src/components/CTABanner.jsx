...
export default function CTABanner() {
  ...
  return (
    <section className="py-20 bg-[#0a0f0d] relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#0a0f0d] via-transparent to-[#0a0f0d]" />

      <div className="max-w-5xl mx-auto px-6 relative z-10">
        <motion.div ref={ref} initial={{ opacity: 0, y: 40 }} animate={inView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.8 }}
          className="glass border border-[#00ff88]/20 rounded-3xl px-8 py-14 text-center glow">

          <div className="w-16 h-16 rounded-2xl gradient-brand flex items-center justify-center mx-auto mb-6 glow">
            <Rocket size={28} className="text-[#0a0f0d]" />
          </div>
          ...
          <p className="text-[#a8c5b2] text-lg max-w-xl mx-auto mb-10">
          ...
          <div className="flex flex-wrap justify-center gap-8 text-sm text-[#6b8c74]">
