...
const testimonials = [
  { name: 'Arjun Sharma', role: 'Full-Time Trader', location: 'Mumbai', rating: 5, avatar: 'AS', color: '#ff8c00',
    text: 'Trade with Bhardwaj completely changed my life. In 6 months I went from losing money consistently to making ₹80,000/month from trading. Bhardwaj sir\'s Price Action course is pure gold.' },
  ...
  { name: 'Rohit Gupta', role: 'CA & Trader', location: 'Pune', rating: 5, avatar: 'RG', color: '#eab308',
    text: 'As a CA I thought I understood markets, but Bhardwaj sir\'s technical analysis framework was eye-opening. The community support group alone is worth the entire course fee.' },
